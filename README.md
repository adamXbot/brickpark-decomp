...
The current source contains **1540 exact full-body function matches**: **664 of
675 exported functions (98.4%)**, plus 876 recovered internal functions.
Another 41 functions are marked work in progress. The export figure
overstates completion: measured in bytes of game code, **44.3% is matched
