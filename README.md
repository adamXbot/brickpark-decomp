...
The current source contains **2869 exact full-body function matches**: **665 of
675 exported functions (98.5%)**, plus 2204 recovered internal functions.
Another 79 functions are marked work in progress. The export figure
overstates completion: measured in bytes of game code, **70.0% is matched
exactly (81.3% including partials)** as of the 2026-09-07 checkpoint
