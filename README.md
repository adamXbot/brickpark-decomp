...
The current source contains **2573 exact full-body function matches**: **665 of
675 exported functions (98.5%)**, plus 1908 recovered internal functions.
Another 77 functions are marked work in progress. The export figure
overstates completion: measured in bytes of game code, **63.6% is matched
exactly (74.8% including partials)** as of the 2026-09-06 checkpoint
