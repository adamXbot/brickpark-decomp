...
The current source contains **2416 exact full-body function matches**: **665 of
675 exported functions (98.5%)**, plus 1751 recovered internal functions.
Another 77 functions are marked work in progress. The export figure
overstates completion: measured in bytes of game code, **60.4% is matched
exactly (71.6% including partials)** as of the 2026-09-05 checkpoint
