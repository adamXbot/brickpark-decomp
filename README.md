...
The current source contains **2455 exact full-body function matches**: **665 of
675 exported functions (98.5%)**, plus 1790 recovered internal functions.
Another 77 functions are marked work in progress. The export figure
overstates completion: measured in bytes of game code, **61.9% is matched
exactly (73.1% including partials)** as of the 2026-09-05 checkpoint
