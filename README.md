...
The current source contains **1542 exact full-body function matches**: **665 of
675 exported functions (98.5%)**, plus 877 recovered internal functions.
Another 39 functions are marked work in progress. The export figure
overstates completion: measured in bytes of game code, **44.4% is matched
