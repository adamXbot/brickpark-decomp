...
The current source contains **2426 exact full-body function matches**: **665 of
675 exported functions (98.5%)**, plus 1761 recovered internal functions.
Another 77 functions are marked work in progress. The export figure
overstates completion: measured in bytes of game code, **61.3% is matched
exactly (72.5% including partials)** as of the 2026-09-05 checkpoint
