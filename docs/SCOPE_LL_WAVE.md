...
| LL3 | `scope/LL3` | 3 | 19 | 1091 | `coaster11.c` | 16/19 — Mass FLOOR; ClipPlane in++ shape, ebx=n blocked |
| LL4 | `scope/LL4` | 4 | 8 | 797 | `coastershade2.c` | 3/8 — Simpson 80/81; Span floors |
