...
(2026-09-07): **2779 exact functions, 80 partials, 67.3% of game code
matched exactly (78.7% with partials).** No game binary or asset is ever committed (`original/` and
