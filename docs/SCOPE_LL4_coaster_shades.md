...
> **Status 2026-09-09: LL4 is MERGED to main.** Its WIP leftovers — the five `coastershade2.c` bodies and `TrackShade_FillPoly` —
> are now claimed by `docs/SCOPE_LL23_coaster_span_raster.md`. Do NOT assign
> anything from this brief; findings live in `docs/lanes/scope-ll4.md`.
