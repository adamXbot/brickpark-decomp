...
> **PORT-M7 — Status: IN PROGRESS (claimed 2026-09-12 by PORT-M7)** — the 72 remaining cast forwarders in the generated closure, declaration and slot type moved together (continues PORT-M3). Notes `docs/lanes/scope-port-m7.md`
