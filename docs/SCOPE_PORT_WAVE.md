...
> **PORT-P2 — Status: IN PROGRESS (claimed 2026-09-12 by PORT-P2)** — playing tutorial lessons 2 (money and planting) and 3 (power and special rides) in the browser build and recording what breaks, with replays. A testing lane: nothing is fixed here. Notes `docs/lanes/scope-port-p2.md`
