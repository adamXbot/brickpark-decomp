...
> **PORT-B9 — Status: IN PROGRESS (claimed 2026-09-12 by PORT-B9)** — make the PARK render and run: A7-1 (the map area does not reach the surface), then drive the park; A7-3 (the loader's 1-byte host reads); B5 (profiles across a reload, A7 §8's IDBFS patch). Notes `docs/lanes/scope-port-b9.md`
