...
> **PORT-M5 — Status: IN PROGRESS (claimed 2026-09-12 by PORT-M5)** — the recovery findings the port lanes filed (M4's four caller/definition name disagreements and 0x00443dc0, M3's open callback slots, B5's texel-formula and sub_458930 findings) and the last three asm rasteriser bodies (`TrackShade_FillPoly`, `Span_FillShade`, `Span_FillShadeZ`). Notes `docs/lanes/scope-port-m5.md`
