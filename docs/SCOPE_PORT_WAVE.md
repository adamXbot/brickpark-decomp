...
> **PORT-B7 — Status: IN PROGRESS (claimed 2026-09-12 by PORT-B7)** — walk the game from PLAYER DETAILS into the park: typing a profile name, every front-end screen, the map screen, and the park fps. Notes `docs/lanes/scope-port-b7.md`
