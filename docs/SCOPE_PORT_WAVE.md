...
> **PORT-A10 — Status: IN PROGRESS (claimed 2026-09-12 by PORT-A10)** — the dual-address gate (PORT-P3 §3.3 promoted to `portable/tools/addr_sweep.py` with a baseline and two ctests; gen_link names every collision in the manifest and in globals.c), P3-4 (`llLink`/`llPad` match the display name too, new `llFind`) and P3-7 (the hidden-tab throttle). Notes `docs/lanes/scope-port-a10.md`**
