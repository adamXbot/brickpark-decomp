...
| --- | --- | --- |
| **bytes of game code matched** | `python3 tools/coverage.py` | **81.9% exact, 94.4% with partials** (2026-09-11, after LL21–LL24, the two LL3/LL4 recoveries and the portable merge) |
| functions matched exactly | `rg -c '^// FUNCTION: LEGOLAND' LEGOLAND/*.c` (sum) | 3281 |
| `verify.py` | `python3 tools/verify.py` (ALONE) | 3279/3279 at 100% (2026-09-11, after LL21–LL24 and the portable merge; 3281 re-verified at the LL3/LL4 recovery merge) |
...
| partials (WIP markers) | `rg -c '^// WIP-FUNCTION:' LEGOLAND/*.c` (sum) | 42 — all listed in §6B |
